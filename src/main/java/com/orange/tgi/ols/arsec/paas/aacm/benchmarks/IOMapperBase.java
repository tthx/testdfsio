...
public abstract class IOMapperBase<T> extends Configured
   ...
   * @throws IOException
   */
  abstract T doIO(Reporter reporter, String name, long value)
      throws IOException;

  /**
   * Create an input or output stream based on the specified file. Subclasses
   * should override this method to provide an actual stream.
   * 
   * @param name file name
   * @return the stream
   * @throws IOException
   ...
   * @throws IOException
   */
  abstract void collectStats(OutputCollector<Text, Text> output, String name,
      long execTime, T doIOReturnValue) throws IOException;

  /**
   * Map file name and offset into statistical data.
   * <p>
   * The map task is to get the <tt>key</tt>, which contains the file name, and
   * the <tt>value</tt>, which is the offset within the file.
   * 
