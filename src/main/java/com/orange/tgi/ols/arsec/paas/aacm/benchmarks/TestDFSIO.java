...
public class TestDFSIO implements Tool {
  ...
  public static final String ERASURE_CODE_POLICY_NAME_KEY
  ...
  public static Path getControlDir(Configuration conf) {
    return new Path(getBaseDir(conf), "io_control");
  }

  public static Path getWriteDir(Configuration conf) {
    return new Path(getBaseDir(conf), "io_write");
  }

  public static Path getReadDir(Configuration conf) {
    return new Path(getBaseDir(conf), "io_read");
  }

  public static Path getAppendDir(Configuration conf) {
  ...
  public static Path getDataDir(Configuration conf) {
    return new Path(getBaseDir(conf), "io_data");
  }

  @SuppressWarnings("deprecation")
  public void createControlFile(FileSystem fs, long nrBytes, // in bytes
  ...
  private String getFileName(int fIdx) {
    return BASE_FILE_NAME + Integer.toString(fIdx);
  }

  public long writeTest(FileSystem fs) throws IOException {
  ...
  public long appendTest(FileSystem fs) throws IOException {
  ...
  public long readTest(FileSystem fs) throws IOException {
  ...
  public long randomReadTest(FileSystem fs) throws IOException {
  ...
  public void analyzeResult(FileSystem fs, TestType testType, long execTime)
      throws IOException {
  ...
  public void cleanup(FileSystem fs) throws IOException {
